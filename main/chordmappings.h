...
{
  ANDROID_dpadcenter       , // MODE==ALPHA       for -CN -M--  0x34 
  ANDROID_dpadcenter       , // MODE==NUMSYM      for -CN -M--  0x34 
  ANDROID_dpadcenter       , // MODE==FUNCTION    for -CN -M--  0x34 
  NONBLE_NOKEY             , // non-BLE shifted   for -CN -M--  0x34 
  NONBLE_NOKEY             , // non-BLE unshifted for -CN -M--  0x34 
  NONBLE_NOKEY             , // non-BLE numsymed  for -CN -M--  0x34 
},
{
